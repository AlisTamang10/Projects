        ...
        <div class="row">
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>Web-Based </span>Blood Bank
          ...
          <!-- <div class="col-md-4 w3l-footer my-md-0 my-4">
            ...
            <ul class="list-unstyled">
              <?php 
// $pagetype="contactus";
// $sql = "SELECT * from tblcontactusinfo WHERE pagetype = :pagetype";
// $query = $dbh -> prepare($sql);
// $query->bindValue(':pagetype',$pagetype,PDO::PARAM_STR);
// $query->execute();
...
// { ?>
              <li>
                ...
                <p class="ml-4">
                  <span><?php  //echo $result['Address']->Address; ?>. </p>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">Web-Based Blood Bank 
