				...
				<div class="contact-right-w3l appoint-form">
					...
					<form action="#" method="post" onsubmit="return checkpass();" name="changepassword">
						...
						<div class="form-group">
							<label for="recipient-name" class="profile-label">Current Password</label>
							<input type="password" class="form-control1" name="currentpassword" id="currentpassword"required='true'>
						</div>
						<div class="form-group">
							<label for="recipient-phone" class="profile-label">New Password</label>
							<input type="password" name="newpassword"  class="form-control1" required="true">
						</div>
						<div class="form-group">
							<label for="recipient-phone" class="profile-label">Confirm Password</label>
							<input type="password" class="form-control1" name="confirmpassword" id="confirmpassword"  required='true'>
						</div>
