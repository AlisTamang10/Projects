...
<head>
	<title>Web-Based Blood Bank | Search Blood Donor </title>
	<!-- Meta tag Keywords -->
			...
			<form name="donar" method="post" style="padding-left: 30px;">
				<div class="row">
					<div class="col-lg-4 mb-4">
						<div class="font-italic"><label>Blood Group <span style="color:red">*</span> </label></div>
					...
					<div class="col-lg-4 mb-4">
						<div class="font-italic"><label>Location </label> </div>
						<div><select name="location" class="form-control" required>
								<?php $sql = "SELECT DISTINCT Address from tblblooddonars ";
								$query = $dbh->prepare($sql);
								$query->execute();
								$results = $query->fetchAll(PDO::FETCH_OBJ);
								$cnt = 1;
				...
				<div class="row">
					<div class="col-lg-4 mb-4">
						<div><label><input type="submit" name="sub" class="btn btn-primary" value="submit" style="cursor:pointer"></label></div>
					</div>
				</div>
				<!-- /.row -->
			</form>
