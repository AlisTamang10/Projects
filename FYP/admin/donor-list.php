...
?>
	...
	<head>
		...
		<title>Web-Based Blood Bank  | Donor List </title>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<a href="download-records.php" style="font-size:16px; margin-top:5px; margin-left:10px" class="btn btn-info">Download Donor List</a>
								<a href="add-donor.php" style="font-size:16px; float:right; margin-right:10px; margin-top:5px;" class="btn btn-info">Add Donor</a>
