...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$ret = "select BloodGroup from tblbloodgroup where BloodGroup=:bloodgroup";
		...
		if ($query->rowCount() == 0) {
			...
			$error = "Blood Group is already on database";
		}
	}
?>
	...
	<head>
		...
		<title>Web-based Blood Bank| Admin add-bloodgroup</title>
								...
								<div class="col-md-10">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form method="post" name="bloodgroup" class="form-horizontal">
